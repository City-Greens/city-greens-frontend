...
export default function Example() {
  ...
  return (
    <div className="bg-white">
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56 ">
          <div className="text-center w-full ">
            <div className=" w-full">
              <h2 className="text-4xl font-bold tracking-tight text-grey-700 sm:text-6xl bg-gray-200 py-8">
      ...
      <h1 className="text-5xl font-bold tracking-tight text-grey-700 sm:text-6xl"> City Greens </h1>

    ...
    <header className="flex justify-between items-center p-4 bg-green-600 text-white w-full">
      <div className="flex-1 flex items-center">
        <ul className="flex space-x-4">
          ...
          <li className="cursor-pointer hover:underline"><Link to="/search">Products</Link></li>
          <li className="cursor-pointer hover:underline"><Link to="/profile">Profile</Link></li>
        </ul>
      </div>
